...
namespace FlowerPlayer
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IMainWindow_Bindings
        {
            ...
            private global::FlowerPlayer.Controls.RangeSlider obj25;
            private global::Microsoft.UI.Xaml.Controls.TextBlock obj26;
            private global::FlowerPlayer.Controls.WaveformControl obj27;
            ...
            private static bool isobj25MaximumDisabled = false;
            private static bool isobj25ValueDisabled = false;
            private static bool isobj25RangeStartDisabled = false;
            private static bool isobj25RangeEndDisabled = false;
            private static bool isobj26TextDisabled = false;
            private static bool isobj27WaveformDataDisabled = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 73 && columnNumber == 90)
                {
                ...
                else if (lineNumber == 75 && columnNumber == 81)
                {
                ...
                else if (lineNumber == 80 && columnNumber == 89)
                {
                ...
                else if (lineNumber == 92 && columnNumber == 96)
                {
                ...
                else if (lineNumber == 93 && columnNumber == 90)
                {
                ...
                else if (lineNumber == 94 && columnNumber == 88)
                {
                ...
                else if (lineNumber == 95 && columnNumber == 108)
                {
                ...
                else if (lineNumber == 96 && columnNumber == 108)
                {
                ...
                {
                    isobj25RangeStartDisabled = true;
                }
                else if (lineNumber == 64 && columnNumber == 32)
                {
                    isobj25RangeEndDisabled = true;
                }
                ...
                {
                    isobj27WaveformDataDisabled = true;
                }
            }
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 16: // MainWindow.xaml line 95
                        ...
                        break;
                    case 17: // MainWindow.xaml line 96
                    ...
                    case 20: // MainWindow.xaml line 98
                        ...
                        break;
                    case 24: // MainWindow.xaml line 56
                    ...
                    case 25: // MainWindow.xaml line 59
                        this.obj25 = global::WinRT.CastExtensions.As<global::FlowerPlayer.Controls.RangeSlider>(target);
                    ...
                    case 27: // MainWindow.xaml line 46
                        this.obj27 = global::WinRT.CastExtensions.As<global::FlowerPlayer.Controls.WaveformControl>(target);
                        break;
                    default:
                        break;
                }
            ...
            private void Invoke_M_FormatTime_2524805749(int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_Microsoft_UI_Xaml_Controls_TextBlock_Text(this.obj24, result, null);
                    }
                }
            }
            ...
            private void Update_ViewModel_TotalDuration_TotalSeconds(global::System.Double obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj25MaximumDisabled)
                    {
                        XamlBindingSetters.Set_FlowerPlayer_Controls_RangeSlider_Maximum(this.obj25, obj);
                    }
                }
            }
            private void Update_ViewModel_SliderPosition(global::System.Double obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    {
                        XamlBindingSetters.Set_FlowerPlayer_Controls_RangeSlider_Value(this.obj25, obj);
                    }
                }
            }
            private void Update_ViewModel_RangeStart(global::System.Double obj, int phase)
            {
                ...
                {
                    // MainWindow.xaml line 59
                    if (!isobj25RangeStartDisabled)
                    {
                        XamlBindingSetters.Set_FlowerPlayer_Controls_RangeSlider_RangeStart(this.obj25, obj);
                    }
                }
            }
            private void Update_ViewModel_RangeEnd(global::System.Double obj, int phase)
            {
                ...
                {
                    // MainWindow.xaml line 59
                    if (!isobj25RangeEndDisabled)
                    {
                        XamlBindingSetters.Set_FlowerPlayer_Controls_RangeSlider_RangeEnd(this.obj25, obj);
                    }
                }
            }
            ...
            private void Update_ViewModel_WaveformData(global::System.Single[] obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj27WaveformDataDisabled)
                    {
                        XamlBindingSetters.Set_FlowerPlayer_Controls_WaveformControl_WaveformData(this.obj27, obj, null);
                    }
                }
            }
            ...
            private void UpdateTwoWay_25_Value()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.SliderPosition = this.obj25.Value;
                        }
                    }
                }
            }
            private void UpdateTwoWay_25_RangeStart()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.RangeStart = this.obj25.RangeStart;
                        }
                    }
                }
            }
            private void UpdateTwoWay_25_RangeEnd()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.RangeEnd = this.obj25.RangeEnd;
                        }
                    }
                }
            }
            ...
            private class MainWindow_obj1_BindingsTracking
            {
                ...
                public void RegisterTwoWayListener_25(global::FlowerPlayer.Controls.RangeSlider sourceObject)
                {
                    ...
                    sourceObject.RegisterPropertyChangedCallback(global::FlowerPlayer.Controls.RangeSlider.RangeStartProperty, (sender, prop) =>
                    {
                        ...
                        if (bindingObj != null)
                        {
                            bindingObj.UpdateTwoWay_25_RangeStart();
                        }
                    });
                    sourceObject.RegisterPropertyChangedCallback(global::FlowerPlayer.Controls.RangeSlider.RangeEndProperty, (sender, prop) =>
                    {
                        ...
                        if (bindingObj != null)
                        {
                            bindingObj.UpdateTwoWay_25_RangeEnd();
                        }
                    });
                }
            }
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 4: // MainWindow.xaml line 43
                ...
                break;
            case 12: // MainWindow.xaml line 81
                {
                    ...
                    ((global::Microsoft.UI.Xaml.Controls.Button)element12).Click += this.OpenFile_Click;
                }
                break;
            case 21: // MainWindow.xaml line 86
                {
                    ...
                    ((global::Microsoft.UI.Xaml.Controls.MenuFlyoutItem)element21).Click += this.OpenSettings_Click;
                }
                break;
            case 22: // MainWindow.xaml line 87
                {
                    ...
                    ((global::Microsoft.UI.Xaml.Controls.MenuFlyoutItem)element22).Click += this.OpenPlaylist_Click;
                }
                break;
            case 23: // MainWindow.xaml line 88
                {
                    ...
                    ((global::Microsoft.UI.Xaml.Controls.MenuFlyoutItem)element23).Click += this.OpenHistory_Click;
                }
                break;
            case 25: // MainWindow.xaml line 59
                {
